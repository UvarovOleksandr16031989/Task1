...
var i = 1;
while(i < 32) {
    elem.innerHTML += `<option class="form_brithday__day_item">
            ${i}
        </option>`;
    i++;
}
...
var n = 0;
while(n < 12) {
    elem.innerHTML += `<option class="form_brithday__month_item">
            ${mouth[n]}
        </option>`;
    n++;
}
...
var x = 1920;
while(x < 2019) {
    elem.innerHTML += `<option class="form_brithday__year_item">
            ${x}
        </option>`;
    x++;
}
